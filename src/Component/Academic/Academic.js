    ...
    <div>
      <section className="text-[#b6fbfd]">
        <div className="px-4 py-16 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8 lg:py-20">
          ...
          <div className="grid max-w-screen-xl mx-auto space-y-6 lg:grid-cols-2 lg:space-y-0 lg:divide-x">
            <div className="space-y-6 sm:px-16">
              <div className="flex flex-col max-w-md sm:flex-row justify-center items-center">
                ...
                <div>
                  <h6 className="mb-3 text-xl font-bold leading-2">Project:</h6>
                  <Fade
                    direction="left
                  "
                  >
                    <p className="text-sm text-gray-300">
                      Designing and development of a Residential Area; Project
                      on: Monsurabad Niribili Abashon Prokolpo- 5.
                    </p>
                  </Fade>
                </div>
              </div>
              <div className="flex flex-col max-w-md sm:flex-row justify-center items-center">
                ...
                <div>
                  <h6 className="mb-3 text-xl font-bold leading-5">Project:</h6>
                  <Fade direction="left">
                    <p className="text-sm text-gray-300">
                      Rural Growth center identification, a case study on
                      Silimpur Union, Bhangura upazila, Bangladesh.
                    </p>
                  </Fade>
                </div>
              </div>
              ...
              <div className="flex flex-col max-w-md sm:flex-row justify-center items-center">
                ...
                <div>
                  ...
                  <Fade direction="right">
                    <p className="text-sm text-gray-300">
                      Socio-economic and Environmental Impact Analysis due to
                      Infrastructure Development Projects in Bangladesh: a case
                      study on Ishwardi-Pabna Railway Project.
                    </p>
                  </Fade>
                </div>
              </div>
