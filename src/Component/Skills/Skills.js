...
import { SiMicrosoftexcel, SiMicrosoftoffice } from "react-icons/si";
    ...
    <div>
      <section class="text-[#b6fbfd]">
        <div class="container px-6 py-10 mx-auto">
          <h1 class="sm:text-2xl font-semibold  capitalize text-3xl ">
          ...
          <div class="lg:hidden lg:flex lg:w-1/2 lg:justify-center">
            <img
              class="w-[24rem] h-[24rem] mx-auto flex-shrink-0 object-cover xl:w-[34rem] xl:h-[34rem] rounded-full"
            ...
            <div class="grid w-full grid-cols-1 gap-8 lg:w-1/2 xl:gap-16 md:grid-cols-2">
              <Slide direction="left">
                <div class="space-y-3">
                  ...
                  <h1 class="text-xl font-semibold  capitalize text-[#b6fbfd]">
                    {" "}
              ...
              <Slide direction="left">
                <div class="space-y-3">
                  ...
                  <h1 class="text-xl font-semibold text-[#b6fbfd] capitalize ">
              ...
              <Slide direction="right">
                <div class="space-y-3">
                  ...
                  <p class="text-gray-300 dark:text-gray-300">MS Excel, SPSS</p>
                </div>
              </Slide>
            </div>
          ...
          <h1 className="pt-4 text-gray-300">
            <span className="text-[#b6fbfd] font-bold">Other Skills:</span>{" "}
            Digital Marketing (SEO, Social media marketing) 2. Video editor, 3.
            Youtuber
          </h1>
        </div>
      </section>
