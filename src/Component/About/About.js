...
const About = () => {
    return (
      ...
      <section class="container mx-auto px-4 py-8 sm:py-12 sm:px-6 lg:py-16 lg:px-8 font-serif">
         <h1 className="text-4xl font-bold text-[#0cf2f8] hover:text-pink-900 sm:hidden my-4">Profile</h1>
  <div class="grid grid-cols-1  lg:grid-cols-2 ">
  
    <div class="col-span-1 relative h-64 sm:h-80 lg:h-full -top-56 right-12 hidden lg:block ">
      <img src="https://i.ibb.co/wRQbScb/Soykot-removebg.png" alt="Large Image" class="absolute inset-y-0   object-contain sm:object-cover" />
    </div>
...
<div class="lg:hidden lg:flex lg:w-1/2 lg:justify-center">
                <img class="w-[24rem] h-[24rem] mx-auto flex-shrink-0 object-cover xl:w-[34rem] xl:h-[34rem] mt-24" src="https://i.ibb.co/THsfhXZ/Soykot-removebg-fotor-bg-remover-20230511191752.png" alt=""/>
            </div>
 <h1 className="text-4xl font-bold text-[#0cf2f8] hover:text-pink-900 lg:hidden my-4">Profile</h1>
