...
const Home = () => {
  return (
    <header
      className="  bg-cover  bg-center object-top w-[100%]  h-[100%]"
      style={{
...
<div className=" relative top-0 bg-gray-800 bg-blend-color bg-opacity-25">
        <div className=" px-4 py-16 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8 lg:py-20">
          <div className="flex flex-col items-center justify-between xl:flex-row ">
            <div className="w-full max-w-xl mb-12 xl:mb-0 xl:pr-16 xl:w-7/12 mx-auto mt-12 ">
              <h1 className=" hover:skew-x-12   max-w-lg mb-6 font-mono font-bold lg:text-5xl tracking-tight text-white sm:text-4xl sm:leading-none">
                Welcome
              </h1>
              ...
              <p className="max-w-xl text-base text-gray-50 md:text-lg">
                <Typewriter
                  options={{
                    strings: [
                      "Planner",
