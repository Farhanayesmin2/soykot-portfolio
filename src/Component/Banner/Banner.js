      ...
      <div className="relative  top-1 bg-gray-900 bg-blend-color bg-opacity-75">
        <div className=" px-4 py-16 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8 lg:py-20">
          <div className="flex flex-col items-center justify-between xl:flex-row ">
           <div className="w-full max-w-xl mb-12 xl:mb-0 xl:pr-16 xl:w-7/12 mx-auto my-44 ">
              <h2 className= "max-w-lg mb-6 font-mono font-bold lg:text-3xl tracking-tight text-white sm:text-4xl sm:leading-none">
               <Typewriter
  options={{
    strings: ['Welcome,', 'I am Soykot Hossain Sarkar.'],
    autoStart: true,
    loop: true,
  }}
/> 
             ...
             <Typewriter
  options={{
    strings: ['Planner', 'Digital Marketer','GIS'],
    autoStart: true,
    loop: true,
  }}
/> 
